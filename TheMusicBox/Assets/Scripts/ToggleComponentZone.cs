...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    {
        [SerializeField]
        [Tooltip("Main Trigger Volume to detect the Activation Object within.Must be on the same physics layer as the Activation Object")]
        Collider m_TriggerVolume;
        

        /// <summary>
        /// Main Trigger Volume to detect the Activation Object Within
        /// Must be on the same physics layer as the Activation Object.
        /// </summary>
        ...
        [SerializeField]
        [Tooltip("Collider that will trigger the component to turn on or off when entering the Trigger Volume. Must have a Rigidbody component and on the same physics layer as the Trigger Volume")]
        Collider m_ActivationObject;

        /// <summary>
        /// Collider that will trigger the component to turn on or off when entering the Trigger Volume
        /// Must have a Rigidbody component and on the same physics layer as the Trigger Volume
        /// </summary>
        ...
        [SerializeField]
        [Tooltip("Component to set the enabled state for. Will set the value to the Enable On Entry value upon entering and revert to the original value on exit.")]
        Behaviour m_ComponentToToggle;

        /// <summary>
        /// Component to set the enabled state for. Will set the value to the
        /// Enable On Entry value upon entry and revert to the original value on exit
        /// </summary>
        ...
        [SerializeField]
        [Tooltip("Sets whether to enable or disable the Component To Toggle uppon entry into the Trigger Volume")]
        bool m_EnableOnEntry = true;

        /// <summary>
        /// Sets whether to enable or diable the Component To Toggle upon entry into the Trigger Volume
        /// </summary>
